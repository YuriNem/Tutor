        ...
        <section className="aboutme">
            ...
            <div className="aboutme__textside">
                ...
                <article className="article">
                    ...
                    <p className="article__text">Работаю репетитором по математике и информатике c 2017 года. За прошлый год успешно подготовил 5 учеников к сдаче экзаменов. Информацию о моих занятиях вы найдете на следующей странице.</p>
                </article>
            </div>
        </section>
    );
